...
public class Initializer implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        productDataStore.add(new Product("Sock of Water Walking", 62.5f, "NK", "you can walk on water but gets terribly wet and uncomfortable", clothing, wizardly));
        productDataStore.add(new Product("Boots of Reverse Flying", 124.5f, "NK", "You will feel upside down floating on the surface", clothing, wizardly));
        productDataStore.add(new Product("Not water", 0, "S","Look, smells and tastes like water, but you know it's not water, neither us nor the cosmos know where it comes from", other, blibdoolpoolp));
        productDataStore.add(new Product("Common fruit", 1, "S", "common", other, blibdoolpoolp));
        productDataStore.add(new Product("Tie of Protection +1", 32, "NK", "Protects your tie from weapon damage", clothing, wizardly));
        ...
        productDataStore.add(new Product("Rubber-duck of Silence", 44, "NK", "If you'd speak to it, your talk won't leave a noise", nickNack, wizardly));
        ...
        productDataStore.add(new Product("Helm of Insight", 2, "S", "Grants us eyes, Grant us eyes! By Kosm or some say Cos, You shall experience the cosmic truth", clothing, blibdoolpoolp));
        ...
        productDataStore.add(new Product("Void Box", 1, "S", "It is not Void because it is empty, It is, because we do not know what it is full of", other, blibdoolpoolp));
        productDataStore.add(new Product("Bag of Bag of Holding Holding", 112, "NK", "A bag of holding that holds bag of holdings", clothing, wizardly));
    }
}
